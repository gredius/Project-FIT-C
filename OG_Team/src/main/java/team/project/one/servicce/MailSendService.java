...
public class MailSendService {
	...
	public String mailSendWithUserKey(String e_mail, String user_id, HttpServletRequest request) {
		...
		String htmlStr = "<h2>안녕하세요 Fit your game! Fit_c 입니다</h2><br><br>" 
				+ "<h3>" + user_id + "님</h3>" + "<p>인증하기 버튼을 누르시면 로그인을 하실 수 있습니다 : " 
				+ "<a href='http://localhost:8888" + request.getContextPath() + "/mailcheck?fit_userid="+ user_id +"&fit_userkeyvalue="+key+"'>인증하기</a></p>"
				+ "(혹시 잘못 전달된 메일이라면 이 이메일을 무시하셔도 됩니다)";
		try {
			mail.setSubject("[본인인증] Fit_C 이메일인증 메일입니다.", "utf-8");
