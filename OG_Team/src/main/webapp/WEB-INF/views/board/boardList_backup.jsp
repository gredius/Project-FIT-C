    ...
    <aside>
	    ...
	    <c:if test="${sessionScope.fit_member == null }">
	    	<form id="/one/login" action="logIN" method="post">
				<table>
					<tr>
						<td width="250px"><input type="text" name="fit_userid" id="fit_userid" placeholder="ID" style="width:90%" /></td>
					</tr>
					<tr>
						<td width="250px"><input type="password" name="fit_userpwd" id="fit_userpwd" placeholder="PASSWORD" style="width:90%" /></td>
					</tr>
					<tr>
